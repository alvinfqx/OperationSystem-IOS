...
//    aFrame.origin = self.bounds.origin;
    aFrame.size.width = ScreenSize.width-10;
...
- (BOOL)textViewShouldBeginEditing:(UITextView *)textView
{
    ...
    self.textView.text = newprevText;
...
{
    newprevText = self.textView.text;
    if (!newprevText || [newprevText length]==0) {
