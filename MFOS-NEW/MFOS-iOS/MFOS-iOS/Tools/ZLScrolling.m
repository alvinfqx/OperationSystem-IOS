 ...
 */
- (instancetype)initWithCurrentController:(UIViewController *)viewcontroller frame:(CGRect)frame photos:(NSArray *)photos placeholderImage:(UIImage *)placeholderImage andView:(UIView*)view
{
    if (self = [super init]) {
        ...
        self.pageControl.frame = CGRectMake(ScreenWidth-photos.count*10.0f, frame.size.height-20, frame.size.width, 15);
...
//        [imageView setImageWithURL:imgUrl placeholderImage:self.placeholder];
