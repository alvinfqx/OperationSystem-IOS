...
- (void)showInView:(UIView *)view {
    NSLog(@"%f",view.frame.size.height);//view.frame.size.height
    
    if (_isBottom) {
        [UIView animateWithDuration:0.7f animations:^{//iew.frame.size.height-300
            self.frame = CGRectMake(0, ScreenHeight-300+44, view.frame.size.width, 300);
        ...
        [UIView animateWithDuration:0.7f animations:^{//iew.frame.size.height-300
            ...
            if (ScreenHeight>=810) {
                self.frame = CGRectMake(0, ScreenHeight-350, view.frame.size.width, 300);
            }else{
                self.frame = CGRectMake(0, ScreenHeight-300, view.frame.size.width, 300);
...
{
    [UIView animateWithDuration:0.7f animations:^{//self.frame.origin.y + self.frame.size.height+300
        self.frame = CGRectMake(0, self.frame.origin.y + self.frame.size.height+300, self.frame.size.width, self.frame.size.height);
    } completion:^(BOOL finished) {
