...
- (void)setLzButtonType:(LZFoldButtonType)lzButtonType {
    ...
    switch (lzButtonType) {
        ...
        case LZFoldButtonTypeRight:{
            ...
            [self.lzButton setContentHorizontalAlignment:UIControlContentHorizontalAlignmentCenter ];//UIControlContentHorizontalAlignmentCenter//UIControlContentHorizontalAlignmentLeft
            [self.lzButton setContentVerticalAlignment:UIControlContentVerticalAlignmentCenter];
            
            [self.lzButton setImageEdgeInsets:UIEdgeInsetsMake(0,titleSize.width + interval+20, 0, -(titleSize.width + interval+100))];
            [self.lzButton setTitleEdgeInsets:UIEdgeInsetsMake(0, -(imageSize.width + interval+20), 0, imageSize.width + interval+100)];
        }
            break;
